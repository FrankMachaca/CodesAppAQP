    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (UserPhoneKey != "" && UserPasswordKey !=""){
            if (!TextUtils.isEmpty(UserPhoneKey) && !TextUtils.isEmpty(UserPasswordKey)){
                ...
                loadingBar.setTitle("Ranudando");
                loadingBar.setMessage("Espere mientra se carga...");
                ...
                if (dataSnapshot.child("Users").child(phone).exists()){
                    ...
                    if (usersData.getPhone().equals(phone)){
                        if (usersData.getPassword().equals(password)){
                            Toast.makeText(MainActivity.this, "Estas Logeado", Toast.LENGTH_SHORT).show();
                            loadingBar.dismiss();
                    ...
                    Toast.makeText(MainActivity.this, "No existe una cuenta con el numero "+ phone, Toast.LENGTH_SHORT).show();
                    loadingBar.dismiss();
                }
            }
